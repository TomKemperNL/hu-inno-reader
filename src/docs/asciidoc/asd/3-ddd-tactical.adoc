...
Ook al is het voorbeeld zeer cliché, de Orders & LineItems laten een vrij standaard probleem zien: vaak willen we niet alleen dat één enkele entity consistent blijft, maar dat er een klein groepje entities samen consistent blijft. Laten we eerst een hele basale versie van dit probleem bekijken:


Het probleem bij <<=>> is dat 
